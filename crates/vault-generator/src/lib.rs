...
pub fn generate_password(opts: PasswordGenOptions) -> Result<String, GeneratorError> {
    ...
    String::from_utf8(password).map_err(|e| GeneratorError::InvalidOptions(e.to_string()))
}
